    ...
    private void createReceipt(Order order) {
        ...
        call.enqueue(new Callback<ResponseObject>() {
            ...
            public void onResponse(Call<ResponseObject> call, Response<ResponseObject> response) {
                if (response.isSuccessful()){
                    Toast.makeText(SelectOrderReceiptActivity.this, R.string.success_create_receipt, Toast.LENGTH_SHORT).show();
                }
                else {
                    try {
                        ...
                        Toast.makeText(SelectOrderReceiptActivity.this, error, Toast.LENGTH_SHORT).show();
                    }
                    catch (Exception e){
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseObject> call, Throwable t) {
                t.printStackTrace();
                Toast.makeText(SelectOrderReceiptActivity.this, R.string.error_500, Toast.LENGTH_SHORT).show();
            }
        });
    }
